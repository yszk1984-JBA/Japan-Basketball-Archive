...
| 3：人間の承認 | VERIFIEDをYuichiが確認 | Batch 005 Wave 1、Approval Sprint 001、Approval Sprint 002を承認済み。Approval Sprint 003は承認待ち |
| 3.5：Master反映 | 承認された範囲だけを正式データへ転記 | 合計20人・61 CareerをMasterへ反映。承認対象外のHOLDは除外 |
...
段階2の候補と検証を継続しながら、Batch 002〜005で31人・96 CareerのVERIFIED候補を作成した。Batch 002の10人・30 CareerはApproval Sprint 003としてHuman Approval待ちであり、Master反映・公開は未実施である。Batch 005 Wave 1、Approval Sprint 001、Approval Sprint 002は対象版・範囲を記録してMasterへ反映した。Masterは合計20人・61 Careerとなり、承認対象外のHOLDは含めていない。承認済み範囲は2026年9月21日に公開サイトへ反映した。今後も10〜20人単位でデータ量と品質を並行して高める。詳細は[DATA_SCALING_WORKFLOW_V0.1](DATA_SCALING_WORKFLOW_V0.1.md)に記録する。確認中データは公開画面でも正式承認前と明示する。
