...
| 3：人間の承認 | VERIFIEDをYuichiが確認 | Batch 005 Wave 1、Approval Sprint 001〜004を承認済み |
| 3.5：Master反映 | 承認された範囲だけを正式データへ転記 | 合計34人・100 CareerをMasterへ反映。承認対象外のHOLDは除外 |
...
| 7：絞り込み・関係探索 | 年代、地域、所属経路、同時所属・チームメイト等の検索を検討 | Relationship Pilot 001はCANDIDATEとして保留。MVPの選手数拡充を優先し、100人以上を目安に再評価 |
...
段階2の候補と検証を継続しながら、Batch 006 Wave 1までVERIFIED候補を作成した。Batch 005 Wave 1、Approval Sprint 001〜004は対象版・範囲を記録してMasterへ反映した。Masterは合計34人・100 Careerとなり、承認対象外のHOLDは含めていない。公開サイトはApproval Sprint 003までの30人・91 Careerを反映済みで、Approval Sprint 004は未反映である。今後も10〜20人単位でデータ量と品質を並行して高める。詳細は[DATA_SCALING_WORKFLOW_V0.1](DATA_SCALING_WORKFLOW_V0.1.md)に記録する。確認中データは公開画面でも正式承認前と明示する。

2026年9月21日、MVPの最短経路として同時所属機能のSchema・画面実装を保留し、B.LEAGUE・プロ選手のデータ拡充を優先する方針を確認した。Batch 006 Wave 1ではMaster未登録の4人から再開する。
