...
def main() -> None:
    ...
    for approval_id in (*APPROVAL_PACKETS, batch_005_approval_id):
    ...
    for person in people:
        ...
        public_people.append({
            ...
            "dataStatus": "master",
            "approvalId": approval_by_person.get(person_id, batch_005_approval_id),
            "facts": facts,
    ...
    approval = approvals_by_id["APP-AS003-20260921-01"]
