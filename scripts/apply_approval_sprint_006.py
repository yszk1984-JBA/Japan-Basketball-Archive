#!/usr/bin/env python3
"""Apply Yuichi's explicit Approval Sprint 006 decision to MASTER.

Generalizes apply_approval_sprint_005.py for the consolidated 22-wave
Approval Sprint 006 packet (Batch 008-018, 82 persons). Mechanics are
...
PACKET = ROOT / "data" / "verified" / "approval_sprint_006"
MASTER = ROOT / "data" / "master"
PACKET_COMMIT = "ba6ae49"
VERIFIED_COMMIT = "8dd71b9"
APPROVAL_ID = "APP-AS006-20260925-01"
...
def verify_approval() -> None:
    ...
    if result.returncode != 0:
        raise SystemExit("Approval Sprint 006 differs from the approved review packet")
    ...
    if any(value not in approval for value in required):
        raise SystemExit("Approval Sprint 006 approval record is incomplete")
...
def main() -> None:
    ...
    master_approvals = merge(
        ...
        [{
            ...
            "batch": "Approval Sprint 006",
            "verified_commit": VERIFIED_COMMIT,
            "approved_scope": "82 persons, 242 careers, 514 supported evidence (22 waves, Batch 008-018)",
            "excluded_scope": "108 HOLD issues, 241 held fields",
            "approved_by": "Yuichi",
            "approved_at": "2026-09-25",
            "approval_reference": "data/verified/approval_sprint_006/master_approval.md",
        }],
...
- `{APPROVAL_ID}`：Approval Sprint 006（強豪校水平展開シリーズ・学校1〜11、Batch 008〜018、22 wave）
