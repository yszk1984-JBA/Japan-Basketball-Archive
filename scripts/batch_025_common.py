...
タグ2名とも新規。帝京長岡高等学校（ORG000217）・東京ユナイテッドバスケットボールクラブ（ORG000223）を新規Organizationとして登録。ブラ ブサナ グロリダは公式プロフィールの出身校（大）が「白?大学」と文字化けして表示されるため、大学Careerは登録していない（issue参照）。
"""

BATCH = 25
SCHOOL_ORG = ('ORG000217', '帝京長岡高等学校')
SCHOOL_TAG = '帝京長岡高等学校'
EXTRA_ORGS = {'ORG000020': '日本体育大学',
