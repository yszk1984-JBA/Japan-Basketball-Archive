#!/usr/bin/env python3
"""Validate Batch 004 Wave 5 (深掘りWave/Enrichment Wave) candidate structure.
...
def main() -> int:
    ...
    report = [
        "# Batch 004 Wave 5（深掘りWave）検証レポート", "", "作成日：2026-09-23", "",
        ...
        "- 対象：河村勇輝（P000064、既にMaster登録済み）のNBA所属歴（Memphis Grizzlies以降）",
