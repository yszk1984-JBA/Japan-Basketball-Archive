# Batch 11 Wave 01 (開志国際高等学校（学校4/11）) VERIFIED

作成日：2026-09-25

状態：VERIFIED候補、HUMAN APPROVAL・MASTER未実施

Batch 11 Wave 01 (開志国際高等学校（学校4/11）)のREADY 11判断について、`eligible_fields`に一致するSUPPORTED Evidenceだけを抽出した。PARTIAL Evidence、`held_fields`、5件のHOLD Issueは除外・分離している。
...
- `organization_verified.csv`：6組織
- `career_verified.csv`：8件
