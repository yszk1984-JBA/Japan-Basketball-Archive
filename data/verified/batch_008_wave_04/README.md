# Batch 8 Wave 04 (福岡大学附属大濠高等学校（学校1/11）) VERIFIED

作成日：2026-09-25

状態：VERIFIED候補、HUMAN APPROVAL・MASTER未実施

Batch 8 Wave 04 (福岡大学附属大濠高等学校（学校1/11）)のREADY 4判断について、`eligible_fields`に一致するSUPPORTED Evidenceだけを抽出した。PARTIAL Evidence、`held_fields`、2件のHOLD Issueは除外・分離している。
...
- `issue_dispositions.csv`：2件のHOLD
