...
状態：外部調査の受領・URL監査完了、CANDIDATE未作成
...
- Person、Career、Organization、EvidenceのCANDIDATE：未作成
...
次は10人分のPerson、Career、Organization、Source、Evidence、IssueをCANDIDATEとして作成し、構造QAを行う。
