...
export default async function PlayerPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="detail-shell">
      ...
      <section className="timeline-section"><p className="eyebrow">Career snapshot</p><h2>確認中の経歴</h2><div className="timeline"><div><span className="year">2020年度</span><span className="timeline-dot" /><div><a href="/organizations/fukuoka-daiichi">福岡第一高等学校</a><p>ウインターカップ2020 登録選手</p></div></div><div><span className="year">卒業後</span><span className="timeline-dot muted" /><div><strong>{player.nextStep}</strong><p>進路記事の記載。入学・在籍は別資料で確認中</p></div></div></div></section>
