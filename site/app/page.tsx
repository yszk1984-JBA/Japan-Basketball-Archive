  ...
  return (
    <main>
      ...
      <section className="content-section">
        <div className="section-heading"><div><p className="eyebrow">Featured players</p><h2>注目選手</h2></div><a href="/organizations" className="text-link">組織一覧を見る <ArrowRight size={17} /></a></div>
